...
/**
 * This class,a subclass of a TextView class which serves as our display,where the user 
 * sees what they are entering and get the results. We extend this class with only one intention
 * of changing the font used on our display so that they look better. For that purpose 
 * we use Roboto-Light font which is located in the Assets/font/ folder
 * 
...
public class CustomTextView extends TextView {
	...
	/*
	 * The next three constructors only do two things,call costructor of a 
	 * super class and then call our method that sets our typeface to Roboto-Light
	 * 
	 * 
	 * Constructors:
	 * 
